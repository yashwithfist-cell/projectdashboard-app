...
const SADashboard = () => {
    ...
    shadow-[0_25px_60px_rgba(37,99,235,0.20)]">
        ...
        shadow-xl rounded-xl px-10 py-3 
        ...
        flex justify-between items-center">
            ...
            <div className="flex flex-col gap-16 items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-28 gap-y-10 justify-items-center">
                    <ActionCard title="Admin" color="border-blue-500" icon={<FaArrowRight />} path="/saadmin" />
                    <ActionCard title="Project" color="border-green-500" icon={<FaArrowRight />} path="/saprojectdata" />
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-28 gap-y-10 justify-items-center">
                    <ActionCard title="Employee" color="border-purple-500" icon={<FaArrowRight />} path="/saempdata" />
